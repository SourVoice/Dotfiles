...
# need git-prompt.sh from github to show working git branch in bash prompt 
...
# If this is an xterm set the title to user@host:dir(the title of the terminal)
...
for file in ~/.{bash_prompt,bash_aliases,functions,path,dockerfunc,extra,exports,git-prompt}; do
